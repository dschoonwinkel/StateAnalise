...
def plot_piechart(filename, category_totals):
    #Plotting
...
def plot_stackedbargraph(category_totals, index, month, fig=None, ax=None, filename="Monthly_stackedbar.pdf"):
    ...
    title_text = re.sub("_transaksies", "", title_text)
    plot.title(title_text)
    filename = re.sub(".csv", "_barstack.pdf", filename)
